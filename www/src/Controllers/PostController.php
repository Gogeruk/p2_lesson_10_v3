...
class PostController
{
    ...
    public function create()
    {
        ...
        return view('pages/form-post', ['tags_s' => $tags_s, 'category_s' => $category, 'tags' => $tags, 'categories' => $categories, 'title' => $title, 'slug' => $slug, 'body' => $body]);
    }
    ...
    public function update($id)
    {
        ...
        return view('pages/form-post', ['tags_s' => $tags_s, 'category_s' => $category, 'tags' => $tags, 'categories' => $categories, 'title' => $title, 'slug' => $slug, 'body' => $body, 'tags' => $tags, 'categories' => $categories, 'body' => $post['body'], 'category_id' => $post['category_id'], 'id' => $post['id'], 'title' => $post['title'], 'slug' => $post['slug']]);
    }
